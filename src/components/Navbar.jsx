...
export default function Navbar() {
  ...
  return (
    ...
    >
      <div
        className={`mx-4 md:mx-8 rounded-2xl transition-all duration-500 ${scrolled ? 'glass px-6 py-3' : 'px-6 py-0'}`}
      ...
      >
        <div className="flex items-center justify-between max-w-6xl mx-auto">
          ...
          <a href="#" className="flex items-center gap-2 group">
            ...
            <span
              className="font-display font-bold text-lg tracking-wider transition-colors group-hover:text-gold-light"
